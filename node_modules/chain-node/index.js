...
Client.prototype.createAsset = function (issuerNodeID, label, cb) {
    var opts = {
        label: label
    }
...
Client.prototype.createAccount = function (managerNodeID, label, cb) {
    var opts = {
        label: label
    }
...
Client.prototype.submitTransactionBatch = function (transactions, cb) {
    this.api.post('/transact/submit', {transactions: transactions}, function(err, results, resp) {
        if (err) {
            return cb(err)
        }
