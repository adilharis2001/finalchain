...
app.get('/fetch_transactions', function (req, res) {
  c.listAccountActivity('acc077DMNP4G085G', function(err, resp){
	res.send(resp);
	});
	...
	c.issue(
	  ...
	  function(err, internalResponse){
		 ...
		 c.keyStore.add(new chain.Xprv(
		  ...
		  },function(err, internalResponse2){
		  	console.log(internalResponse2);
		  })
...
c.createAsset('in072ERNKPG09QY', 'Test Sample 5', function(err, resp){
	//console.log(resp['id']);
	//console.log(resp['issuer_node_id']);
	//console.log(resp['label']);
	c.keyStore.add(new chain.Xprv(
		'xprv9s21ZrQH143K3nxTwQdviZJrF3UaKity2icgCmQHnTLwda71eFAhn6hsTcAVZzQXqKwmvU8JLz9ZPwFFExUBb9yfKGVQJvkmKrVZsFwqDTw', // Replace
		true
 	 ));
...
// Adil Issuer Node: xprv9s21ZrQH143K3nxTwQdviZJrF3UaKity2icgCmQHnTLwda71eFAhn6hsTcAVZzQXqKwmvU8JLz9ZPwFFExUBb9yfKGVQJvkmKrVZsFwqDTw